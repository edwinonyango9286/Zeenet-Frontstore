              ...
              <div>
                <div className="col-12">
                  <h3 className="section-heading">
                    {productState.length === 0 ? " " : "Featured collections"}{" "}
                  </h3>
                </div>
                <div className="col-12 d-inline-flex  flex-row  align-items-center justify-content-center justify-content-lg-start gap-10 flex-wrap ">
                  {productState &&
